...
contract RerollTicket is ERC721, ERC721Enumerable, ERC721Pausable, Ownable, ERC721Burnable {
    ...
    uint256 public batch0Price = 2 ether;
    ...
    uint256 public batch2Price = 80 ether;
    uint256 public maxPerWalletBatch2 = 2;
    ...
    constructor(address initialOwner, address _gueio, address _appleTree)
        ERC721("Reroll Ticket MyDuckly", "TRM")
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://myduckly.com/api/nft/reroll-ticket/";
    }
    ...
    function batch0Mint() external payable {
        ...
        require(gueioId < 512, "You minted all Reroll Ticket MyDuckly with your Gueios");
    ...
    function batch1Mint() external payable {
        ...
        require(appleTreeId < 3000, "You minted all Reroll Ticket MyDuckly with your Apple Trees");
